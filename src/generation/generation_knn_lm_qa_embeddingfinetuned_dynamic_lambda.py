#!/usr/bin/env python3
"""
KNN-LM Generation with FINE-TUNED EMBEDDINGS: DYNAMIC LAMBDA VERSION
...
class FiveTaskDynamicLambdaKNNLMGenerator:
    """KNN-LM generator with FINE-TUNED EMBEDDINGS and DYNAMIC LAMBDA per token"""
    ...
    def __init__(self, model_path: str = "mistralai/Mistral-7B-Instruct-v0.2", 
        ...
        print("⚡ KNN-LM GENERATOR (FINE-TUNED EMBEDDINGS + DYNAMIC LAMBDA)")
        print("=" * 70)
        ...
        print(f"TASK: 2b-Combined1NN (DYNAMIC λ)")
        sys.stdout.flush()
    ...
    def evaluate_on_questions(self, qa_pairs: List[dict], output_file: str):
        ...
        print("\n🧪 COMBINED LM+1NN EVALUATION (WITH FINE-TUNED EMBEDDINGS + DYNAMIC LAMBDA)")
        print("=" * 80)
        sys.stdout.flush()
    ...
    def run_complete_pipeline(self, train_file: str, test_file: str, output_file: str):
        ...
        print(f"\n🎯 KNN-LM PIPELINE (COMBINED LM+1NN WITH FINE-TUNED EMBEDDINGS)")
...
def main():
    ...
    try:
        ...
        print("\n✅ COMBINED LM+1NN TASK COMPLETED WITH FINE-TUNED EMBEDDINGS + DYNAMIC LAMBDA!")
