...
class LMOnlyGenerator:
    """LM-only generator - Task 1a only - WITH FINE-TUNED MODEL"""
    
    def __init__(self, model_path: str = "mistralai/Mistral-7B-Instruct-v0.2", adapter_path: str = "./model_checkpoints/mistral_tofu_lora_fixed_20250722_133126"):
...
def main():
    ...
    parser.add_argument('--adapter-path', default='./model_checkpoints/mistral_tofu_lora_fixed_20250722_133126', help='Path to fine-tuned LoRA adapter')
    
    args = parser.parse_args()
    
    generator = None
    try:
        generator = LMOnlyGenerator(adapter_path=args.adapter_path)
