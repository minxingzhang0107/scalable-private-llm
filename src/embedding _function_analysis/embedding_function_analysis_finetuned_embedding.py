#!/usr/bin/env python3
"""
KNN-LM Generation with FINE-TUNED EMBEDDINGS: DYNAMIC LAMBDA VERSION + DATASTORE REMOVAL
...
class FiveTaskDynamicLambdaKNNLMGenerator:
    """KNN-LM generator with FINE-TUNED EMBEDDINGS and DYNAMIC LAMBDA per token + DATASTORE REMOVAL"""
    ...
    def __init__(self, model_path: str = "mistralai/Mistral-7B-Instruct-v0.2", 
        ...
        print("⚡ KNN-LM GENERATOR (FINE-TUNED EMBEDDINGS + DYNAMIC LAMBDA + DATASTORE REMOVAL)")
        print("=" * 70)
    ...
    def build_datastore(self, qa_pairs: List[dict]):
        """Build datastore using FINE-TUNED embeddings with original indices"""
        print("\n🔨 BUILDING DATASTORE (FINE-TUNED EMBEDDINGS + SMART BATCHING + FAISS + ORIGINAL INDICES)")
        print("-" * 70)
        sys.stdout.flush()
    ...
    def evaluate_on_questions(self, qa_pairs: List[dict], output_file: str):
        ...
        print("\n🧪 COMBINED LM+1NN EVALUATION (WITH FINE-TUNED EMBEDDINGS + DYNAMIC LAMBDA + DATASTORE REMOVAL)")
        print("=" * 80)
        sys.stdout.flush()
    ...
    def run_complete_pipeline(self, train_file: str, test_file: str, output_file: str):
        ...
        print(f"\n🎯 KNN-LM PIPELINE (COMBINED LM+1NN WITH FINE-TUNED EMBEDDINGS + DATASTORE REMOVAL)")
        ...
        print(f"\n🎯 PIPELINE COMPLETE!")
        print(f"   Combined LM+1NN completed with FINE-TUNED EMBEDDINGS + DYNAMIC LAMBDA + DATASTORE REMOVAL!")
        print(f"   🤖 LM: Pre-trained | 🎯 Embeddings: Fine-tuned")
...
def main():
    ...
    try:
        ...
        print("\n✅ COMBINED LM+1NN TASK COMPLETED WITH FINE-TUNED EMBEDDINGS + DYNAMIC LAMBDA + DATASTORE REMOVAL!")
