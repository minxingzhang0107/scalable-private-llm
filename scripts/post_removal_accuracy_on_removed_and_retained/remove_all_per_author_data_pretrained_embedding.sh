...
# OUTPUT_FILE="results/post_removal_accuracy_on_removed_and_retained/1nn_ds_only_pretrained_embedding_with_removal_generated_answers.json"
# OUTPUT_FILE="results/post_removal_accuracy_on_removed_and_retained/combined_pretrained_embedding_with_removal_generated_answers_distance_0.4.json"
OUTPUT_FILE="results/post_removal_accuracy_on_removed_and_retained/combined_pretrained_embedding_with_removal_generated_answers_distance_0.4.json"
...
echo "   🗑️ Datastore Removal: Enabled (per-query removal by author_index)"
...
python src/post_removal_accuracy_on_removed_and_retained/remove_all_per_author_data_pretrained_embedding.py \
...
if [ $? -eq 0 ]; then
    ...
    echo "   🗑️ Datastore Removal: Enabled - removes QA pairs by author_index during testing"
    echo "   🔥 Dynamic λ rule:"
